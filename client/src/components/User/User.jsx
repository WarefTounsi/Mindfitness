...
function User({ firstName, lastName, img, dispatch, id, getMessages }) {
    ...
    let token = JSON.parse(sessionStorage.getItem('auth'))['accessToken'];
        ...
        await axios.get(`http://localhost:8800/conversations/with/${id}`, config).then((res) => {
