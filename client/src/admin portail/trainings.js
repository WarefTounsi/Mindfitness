...
import { Create, Edit, List, TabbedForm, SimpleFormIterator, ImageField, FileInput, NumberInput, FileField, ArrayInput, FormTab, Form, Title, AutocompleteArrayInput, TextInput, SaveButton,TextField, DateField, Datagrid, EditButton, DeleteButton, SelectInput, EmailField, RichTextField} from 'react-admin';
        ...
        <Edit>
            <TabbedForm >
                <FormTab label="summary">
                        ...
                        <AutocompleteArrayInput source="tags" fullWidth choices={[
        ...
        <TabbedForm >
                ...
                <FormTab label="description">
                    ...
                    <FileInput fullWidth source="image" >
                         <FileField multiple={false} source="src" label="support your course with an image" accept="image/*"/>
                    </FileInput>
                    <FileInput fullWidth source="video" >
                         <FileField multiple={false} source="src" label="support your course with a little teaser" accept="video/*"/>
                    </FileInput>
                </FormTab>
                <FormTab label="prerequisites">
                    <ArrayInput source="prerequisties" label="" >
